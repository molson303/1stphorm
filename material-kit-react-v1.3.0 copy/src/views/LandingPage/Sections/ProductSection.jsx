        ...
        <div>
          <StyledGridContainer>
            <StyledGridItem xs={12} sm={12} md={4}>
              <GoalCard
                link="https://1stphorm.com/products/fat-burners/womens-fat-burners?a_aid=cpt"
            ...
            <StyledGridItem xs={12} sm={12} md={4}>
              <GoalCard
                link="https://1stphorm.com/products/fat-burners/mens-fat-burners?a_aid=cpt"
            ...
            <StyledGridItem xs={12} sm={12} md={4}>
              <GoalCard
                link="https://1stphorm.com/products/stacks/muscle-building?a_aid=cpt"
            ...
            <StyledGridItem xs={12} sm={12} md={6}>
              <GoalCard
                link="https://1stphorm.com/products/health-wellness?a_aid=cpt"
